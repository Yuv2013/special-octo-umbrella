class Game {
  ...
  showFuelBar() {
    push();
    image(fuelImage, windowWidth + player.positionX, windowHeight/2, 20, 20);
    fill("white");
    rect(windowWidth/2+ player.positionX, windowHeight/2, 185, 20);
    fill("#ffc400");
    rect(windowWidth/2+ player.positionX, windowHeight/2, player.fuel, 20);
    noStroke();
    pop();
  }
  ...
  handlePlayerControls() {
    ...
    if (keyIsDown(DOWN_ARROW) && player.positionX > width / 3 - 50) {
